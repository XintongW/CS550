...
Display( )
{
    ...
    SetSpotLight( GL_LIGHT1, 2, 2, 2, 0, 0, 1, 0, 1, 0 );
    ...
    SetMaterial( 0.83, 0.85, 0.91, 50. );
    glCallList( Torus );
    glPopMatrix();
    
    glPushMatrix();
    glShadeModel( GL_SMOOTH );
    SetMaterial( 0., 1., 0., 50. );
    
    glTranslatef(0., 0., 20 * sin(Time * 6.1));
    SetPointLight( GL_LIGHT2, 0, 0, 20 * sin(Time * 6.1), 1, 1, 1 );
    //glTranslated(0., 0., 50 * cos(Time));
    //glTranslated(0., 0., 50 * sin(Time));
    //glRotatef( 360.*Time, 0., 1., 0. );
    //SetPointLight( GL_LIGHT2, 0, 0, 50, 1, 1, 1 );
    glCallList( Cube );
    glPopMatrix();

    glPushMatrix();
    glShadeModel( GL_SMOOTH );
    SetMaterial( 0.7, 0.31, 0.14, 50. );
    glTranslatef(-7, -7, 12);
...
InitLists( )
{
    ...
    LoadObjFile( "/Users/apple/CS/CS550_Project4/CS550_Project4/torus.obj" );
    glEndList( );
